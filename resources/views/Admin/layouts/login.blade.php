...
<body class="bg-gray-100 flex justify-center items-center min-h-screen p-4">
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-3 flex flex-col gap-3">
        ...
        <div class="flex flex-col">
            <a href="{{ url('admin/register') }}" class="text-center text-blue-500 hover:text-blue-600 hover:underline">
                Register a new membership </a>
            <a href="{{ url('admin/forgotpass') }}"
                class="text-center text-blue-500 hover:text-blue-600 hover:underline"> I forgot my password </a>
        </div>
    </div>
</body>
