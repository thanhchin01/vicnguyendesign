    ...
    <div class="card mb-4 container">
        <div class="card-header">
            <div class=" d-flex justify-content-between">
                <form class="d-flex" role="search" action="{{ route('admin.admin.contacts') }}" method="GET">
                    <input class="form-control me-2" type="search" placeholder="Search" value="{{ request('keyword') }}" name="keyword">
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group" aria-label="Basic action group">
                                <a href="{{ route('admin.details', $item->id) }}" class="btn btn-primary btn-sm me-2"
                                    title="">
